...
namespace NanoCuidado.Controllers
{
    ...
    public class ExamesController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Exames.Include(e => e.Paciente);
        ...
        public async Task<IActionResult> Create([Bind("ExameId,Descricao,Preco,PacienteId")] Exame exame)
        {
            ...
            ViewData["PacienteId"] = new SelectList(_context.Pacientes, "PacienteId", "PacienteId", exame.PacienteId);
            return View(exame);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ExameId,Descricao,Preco,PacienteId")] Exame exame)
        {
            if (id != exame.ExameId)
            {
                return NotFound();
