...
namespace NanoCuidado.Controllers
{
    ...
    public class FornecedorController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FornecedorId,Nome,Contato,Telefone,Email")] Fornecedor fornecedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FornecedorId,Nome,Contato,Telefone,Email")] Fornecedor fornecedor)
        {
